      ...
      <div className="grid place-items-center lg:max-w-screen-xl gap-8 mx-auto py-20 md:py-32">
        <div className="text-center space-y-8">
          <Badge variant="outline" className="text-sm py-2">
            ...
            <span>Mailvibe: Production ready email marketing SaaS</span>
          </Badge>
          ...
          <p className="max-w-screen-sm mx-auto text-xl text-muted-foreground">
            Create, send, and track email campaigns to your audience. Advanced deliverability, campaign analytics, and a simple dashboard built for founders who want results.
          </p>
